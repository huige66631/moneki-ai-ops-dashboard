...
export async function askAssistant(question: string, context?: { start_date: string; end_date: string }, sessionId?: string, signal?: AbortSignal): Promise<AssistantResponse> {
